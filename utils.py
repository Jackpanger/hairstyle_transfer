...
def load_and_split_image(path, return_mask = False):
    ...
    if os.path.exists(hair_path_with_filename):
        ...
        print("Data type:", inner_f_im.dtype)
        print("Data range:", inner_f_im.min(), inner_f_im.max())
        print("Data shape:", inner_f_im.shape)
...
import dlib
predictor = dlib.shape_predictor('/content/drive/MyDrive/model/shape_predictor_68_face_landmarks.dat')
